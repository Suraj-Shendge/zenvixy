        ...
        <div className="bg-card rounded-3xl p-8 shadow-card border border-border">
          <div className="text-center mb-8">
            <Link href="/" className="inline-flex items-center gap-2 mb-6">
              ...
              <span className="text-xl font-semibold text-foreground">Zenvixy</span>
            </Link>
            <h1 className="text-2xl font-semibold text-foreground mb-2">Welcome back</h1>
            <p className="text-tertiary">Sign in to access your dashboard</p>
          </div>
          ...
          <p className="text-center text-sm text-tertiary mt-6">
            Don't have an account? <Link href="/pricing" className="text-accent font-medium hover:underline">Sign up free</Link>
          </p>
        </div>
      </div>
    </div>
